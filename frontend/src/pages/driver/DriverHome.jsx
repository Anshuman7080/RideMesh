...
import { Power, ShieldAlert, Award, ArrowRight, MapPin,  Star, Navigation, DollarSign, ListCollapse, CheckCircle2 } from 'lucide-react';
  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        ...
        <h3 className="text-lg font-extrabold text-primary mt-1">{profile?.totalTrips || 5}</h3>
        <p className="text-[9px] text-gray-400 mt-1 font-medium">↑ 12 this week</p>
      </Card>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider">Driver's Rating</span>
          <div className="w-7 h-7 rounded-full bg-accent-blue/10 flex items-center justify-center">
            <Star size={13} className="text-accent-blue" />
          </div>
        </div>
        <h3 className="text-lg font-extrabold text-accent-blue mt-1 flex items-center gap-1">
          {profile?.rating || 3}
          <span className="text-[10px] font-medium text-gray-400">/ 5</span>
        </h3>
        <p className="text-[9px] text-gray-400 mt-1 font-medium">Based on {profile?.totalTrips} rides</p>
      </Card>
    </div>
